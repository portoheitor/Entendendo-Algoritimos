...
| 2 | Ordenação por Seleção | Selection Sort, Arrays vs Listas Encadeadas | 🔜 Em andamento |
| 3 | Recursão | Casos-base, pilha de chamadas | ⬜ Planejado |
...
├── Cap01_IntroBigO/              # Código-fonte do capítulo
│   └── BinarySearch.cs
├── Cap01_IntroBigO.Tests/        # Testes correspondentes (xUnit)
